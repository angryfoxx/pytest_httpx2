...
async def test_default_response(httpx_mock: HTTPXMock) -> None:
    ...
    assert response.headers == httpx2.Headers({})
...
async def test_url_query_params_partial_matching(httpx_mock: HTTPXMock) -> None:
    ...
    async with httpx2.AsyncClient() as client:
        response = await client.post("https://test_url?a=1&b=2&a=3&c=4&d=5&d=6&e=7")
        assert response.content == b""
...
async def test_with_many_responses_urls_str(httpx_mock: HTTPXMock) -> None:
    ...
    async with httpx2.AsyncClient() as client:
        response = await client.post(
            httpx2.URL("https://test_url", params={"param2": "test"})
        )
        assert response.content == b"test content 2"

        response = await client.get(
            httpx2.URL("https://test_url", params={"param1": "test"})
        )
        assert response.content == b"test content 1"

        response = await client.put(
            httpx2.URL("https://test_url", params={"param3": "test"})
        )
        assert response.content == b"test content 3"

        response = await client.head(
            httpx2.URL("https://test_url", params={"param6": "test"})
        )
        assert response.content == b"test content 6"

        response = await client.patch(
            httpx2.URL("https://test_url", params={"param5": "test"})
        )
        assert response.content == b"test content 5"

        response = await client.delete(
            httpx2.URL("https://test_url", params={"param4": "test"})
        )
        assert response.content == b"test content 4"
...
async def test_callback_with_pattern_in_url(httpx_mock: HTTPXMock) -> None:
    ...
    def custom_response2(request: httpx2.Request) -> httpx2.Response:
...
async def test_async_callback_with_await_statement(httpx_mock: HTTPXMock) -> None:
    ...
    def instant_response(request: httpx2.Request) -> httpx2.Response:
        return httpx2.Response(
...
async def test_async_callback_with_pattern_in_url(httpx_mock: HTTPXMock) -> None:
    ...
    async def custom_response2(request: httpx2.Request) -> httpx2.Response:
        return httpx2.Response(
            status_code=200,
            extensions={"http_version": b"HTTP/2.0"},
            json={"url": str(request.url)},
...
@pytest.mark.parametrize(
    ...
    [
        # httpx2 exception without request context
        pytest.param(
            httpx2.HTTPError, "Unable to read within 5.0", id="non_request_exception"
        ),
...
async def test_callback_not_returning_a_response(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == "Callback registered for GET request on https://test_url MUST return httpx2.Response"
        )
...
async def test_headers_matching_respect_case(httpx_mock: HTTPXMock) -> None:
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for GET request on https://test_url with {{'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers amongst:
- Match any request with {{'user-agent': 'python-httpx2/{httpx2.__version__}'}} headers"""
        )
...
async def test_headers_not_matching(httpx_mock: HTTPXMock) -> None:
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for GET request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers amongst:
- Match any request with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2', 'Host2': 'test_url'}} headers"""
        )
...
async def test_requests_retrieval_proxy_matching(httpx_mock: HTTPXMock) -> None:
    ...
    async with httpx2.AsyncClient(
        mounts={
            "http://": httpx2.AsyncHTTPTransport(proxy="http://my_test_proxy"),
            "https://": httpx2.AsyncHTTPTransport(
...
async def test_headers_not_matching_and_content_matching(httpx_mock: HTTPXMock) -> None:
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match any request with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body' body"""
        )
...
async def test_headers_matching_and_content_not_matching(httpx_mock: HTTPXMock) -> None:
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match any request with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url'}} headers and b'This is the body2' body"""
        )
...
async def test_headers_and_content_not_matching(httpx_mock: HTTPXMock) -> None:
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match any request with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body2' body"""
        )
...
async def test_headers_not_matching_and_url_and_content_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match any request on https://test_url with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body' body"""
        )
...
async def test_url_and_headers_not_matching_and_content_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match any request on https://test_url2 with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body' body"""
        )
...
async def test_url_and_headers_matching_and_content_not_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match any request on https://test_url with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url'}} headers and b'This is the body2' body"""
        )
...
async def test_headers_matching_and_url_and_content_not_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match any request on https://test_url2 with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url'}} headers and b'This is the body2' body"""
        )
...
async def test_url_matching_and_headers_and_content_not_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match any request on https://test_url with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body2' body"""
        )
...
async def test_url_and_headers_and_content_not_matching(httpx_mock: HTTPXMock) -> None:
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match any request on https://test_url2 with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body2' body"""
        )
...
async def test_headers_not_matching_and_method_and_url_and_content_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match POST request on https://test_url with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body' body"""
        )
...
async def test_url_and_headers_not_matching_and_method_and_content_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match POST request on https://test_url2 with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body' body"""
        )
...
async def test_method_and_url_and_headers_matching_and_content_not_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match POST request on https://test_url with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url'}} headers and b'This is the body2' body"""
        )
...
async def test_method_and_headers_matching_and_url_and_content_not_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match POST request on https://test_url2 with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url'}} headers and b'This is the body2' body"""
        )
...
async def test_method_and_url_matching_and_headers_and_content_not_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match POST request on https://test_url with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body2' body"""
        )
...
async def test_method_matching_and_url_and_headers_and_content_not_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match POST request on https://test_url2 with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body2' body"""
        )
...
async def test_method_and_url_and_headers_and_content_not_matching(
    ...
    async with httpx2.AsyncClient() as client:
        ...
        assert (
            str(exception_info.value)
            == f"""No response can be found for POST request on https://test_url with {{'Host': 'test_url', 'User-Agent': 'python-httpx2/{httpx2.__version__}'}} headers and b'This is the body' body amongst:
- Match PUT request on https://test_url2 with {{'User-Agent': 'python-httpx2/{httpx2.__version__}', 'Host': 'test_url2'}} headers and b'This is the body2' body"""
        )
...
async def test_timeout_matching(httpx_mock: HTTPXMock) -> None:
    ...
    async with httpx2.AsyncClient() as client:
        response = await client.put(
            "https://test_url", timeout=httpx2.Timeout(5, write=10)
        )
    assert response.content == b""
